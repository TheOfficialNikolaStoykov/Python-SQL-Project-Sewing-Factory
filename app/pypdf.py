...
class PDFdisplay(wx.Dialog):
    def __init__(self, parent, filename):
        ...
        self.ButtonNext = wx.Button(
            self, wx.ID_ANY, "forw", defPos, defSiz, wx.BU_EXACTFIT
        )
        # backward button
        self.ButtonPrevious = wx.Button(
            self, wx.ID_ANY, "back", defPos, defSiz, wx.BU_EXACTFIT
        )
        # ======================================================================
        ...
        self.statPageMax = wx.StaticText(
            self, wx.ID_ANY, "of " + str(len(self.doc)) + " pages.", defPos, defSiz, 0
        )
        self.links = wx.CheckBox(
            self, wx.ID_ANY, "show links", defPos, defSiz, wx.ALIGN_LEFT
        )
        ...
        self.PDFimage = wx.StaticBitmap(
            self, wx.ID_ANY, self.pdf_show(1), defPos, defSiz, style=0
        )
        # ======================================================================
